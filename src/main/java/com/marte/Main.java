...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        log.info("Subscriptor 1  subscribed");
        coldPublisher.subscribe(n -> log.info("[s1] {}",n));
        log.info("Subscriptor 2  subscribed");
        coldPublisher.subscribe(n -> log.info("[s2] {}",n));
        log.info("Subscriptor 3  subscribed");
        ...
        log.info("Subscriptor 4  subscribed");
        hotPublisher.subscribe(n -> log.info("[s4] {}",n));

        log.info("Subscriptor 5  subscribed");
        hotPublisher.subscribe(n -> log.info("[s5] {}",n));

        log.info("Subscriptor 6  subscribed");
        ...
        /* Database.getDataAsFlux()
                ...
                .contextWrite(Context.of("userId", "100412123"))
